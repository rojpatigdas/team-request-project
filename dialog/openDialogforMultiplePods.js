 ...
 */
function openDialogforMultiplePods(event) {
  utilprocess()
  return {
    "action_response": {
      "type": "DIALOG",
              ...
              },
              {
                ...
                // Add an empty section for spacing
                  ...
                  },
                  {
                      "selectionInput": {
                        "type": "RADIO_BUTTON",
                        "label": "<UNDER DEVELOPMENT DO NOT USE>Do you also need help from Finance?",
                        "name": "nneedFinance",
                        "items": [
                          {
                            "text": "Yes",
                          ...
                          "onClick": {
                            "action": {
                              ...
                              // Specifies which function to run
                                ...
                                "function": "nextDialogforMultiplePods",
                                "parameters": [
                                  {
                                    "key": "nextDialogforMultiplePods",
                                    "value": "nextDialogforMultiplePods"
                                  }
                                ]
                            }
                          }
...
function nextDialogforMultiplePods(event) {
